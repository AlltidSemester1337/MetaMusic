...
public interface TestConstants {
    ...
    String EXAMPLE_TRACK_INVALID_REQUEST_PAYLOAD_INVALID_TITLE = createTrackPayload("", EXAMPLE_ARTIST_NAME, EXAMPLE_GENRE, EXAMPLE_DURATION_TEXT, EXAMPLE_RELEASE_DATE_TEXT);
